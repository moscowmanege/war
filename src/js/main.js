...
$(function() {
	...
	$(document).on('mousemove', '.preview-body', function(event) {
		var $this = $(this);
		var percentY = (event.pageY - $this.offset().top) / $this.height() * 1.25 - 0.40;
	...
	$(document).on('click', '.preview-title, .preview-description', function(event) {
